...
namespace GF2toolkit {
  ...
  */
  ...
  #define TTT   TT(0)^TT(1)^TT(2)^TT(3)

  template <>
  void
  MM4RmultAssBlock<uint32_t,8>( uint32_t const * A, unsigned nRowsA,
                                uint32_t const * B_Tables,
                                uint32_t       * C ) {

    #define MM4R_SINGLE_OP { uint32_t tmp = *A++ ; if ( tmp != 0 ) *C = TTT ; else *C = 0 ; ++C ; }
  ...
  template <>
  void
  MM4RmultAddBlock<uint32_t,8>( uint32_t const * A, unsigned nRowsA,
                                uint32_t const * B_Tables,
                                uint32_t       * C ) {

    #define MM4R_SINGLE_OP { uint32_t tmp = *A++ ;  if ( tmp != 0 ) *C ^= TTT ; ++C ; }
    MM4R_LOOP_UNROLLED_BY_16 ;
    #undef MM4R_SINGLE_OP
  }
  ...
  template <>
  void
  MM4RmultRightBlock<uint32_t,8>( uint32_t       * A, unsigned nRowsA,
                                  uint32_t const * B_Tables ) {

    #define MM4R_SINGLE_OP { uint32_t tmp = *A ; if ( tmp != 0 ) *A = TTT ; ++A ; }
    MM4R_LOOP_UNROLLED_BY_16 ;
    #undef MM4R_SINGLE_OP
  }
  ...
  template <>
  void
  MM4RmultAssBlock<uint64_t,8>( uint64_t const * A, unsigned nRowsA,
                                uint64_t const * B_Tables,
                                uint64_t       * C ) {

    #define MM4R_SINGLE_OP { uint64_t tmp = *A++ ; if ( tmp != 0 ) *C = TTT ; else *C = 0 ; ++C ; }
    MM4R_LOOP_UNROLLED_BY_16 ;
    #undef MM4R_SINGLE_OP
  }
  ...
  template <>
  void
  MM4RmultAddBlock<uint64_t,8>( uint64_t const * A, unsigned nRowsA,
                                uint64_t const * B_Tables,
                                uint64_t       * C ) {

    #define MM4R_SINGLE_OP { uint64_t tmp = *A++ ; if ( tmp != 0 ) *C ^= TTT ; ++C ; }
    MM4R_LOOP_UNROLLED_BY_16 ;
    #undef MM4R_SINGLE_OP
  }
  ...
  template <>
  void
  MM4RmultRightBlock<uint64_t,8>( uint64_t       * A, unsigned nRowsA,
                                  uint64_t const * B_Tables ) {
  ...
  template <>
  void
  MM4RmultAssBlock<uint128_t,8>( uint128_t const * A, unsigned nRowsA,
  ...
  template <>
  void
  MM4RmultAddBlock<uint128_t,8>( uint128_t const * A, unsigned nRowsA,
                                 uint128_t const * B_Tables,
                                 uint128_t       * C ) {
  ...
  template <>
  void
  MM4RmultRightBlock<uint128_t,8>( uint128_t       * A, unsigned nRowsA,
                                   uint128_t const * B_Tables ) {
...
// EOF GF2toolkit_4RussianMult8bit.cc
